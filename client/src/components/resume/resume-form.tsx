  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white min-h-screen">
      <div className="p-6 space-y-8">
        ...
        {/* Education Section */}
        <div className={`space-y-4 ${!sectionVisibility.education ? 'opacity-50' : ''}`}>
        ...
        <div className={`space-y-4 ${!sectionVisibility.workExperience ? 'opacity-50' : ''}`}>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
        ...
        {/* Projects Section */}
        <div className={`space-y-4 ${!sectionVisibility.projects ? 'opacity-50' : ''}`}>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
        ...
        {/* PORs Section */}
        <div className={`space-y-4 ${!sectionVisibility.pors ? 'opacity-50' : ''}`}>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
        ...
        <div className={`space-y-4 ${!sectionVisibility.achievements ? 'opacity-50' : ''}`}>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
        ...
        <div className={`space-y-4 ${!sectionVisibility.certifications ? 'opacity-50' : ''}`}>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
        ...
        {/* Skills Section */}
        <div className={`space-y-4 ${!sectionVisibility.skills ? 'opacity-50' : ''}`}>
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
