    ...
    <div className="h-screen bg-background flex flex-col">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="px-3 py-1 text-xs h-8 border-orange-300 text-orange-600"
            >
              Change Template
            </Button>
            ...
            <Button
              ...
              className="px-3 py-1 text-xs h-8 bg-blue-600 text-white  flex items-center gap-1"
            >
            ...
            <Button
              ...
              className="px-3 py-1 text-xs h-8 border-green-300 text-green-600  flex items-center gap-1"
            >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className={`${isSidebarVisible ? 'w-1/2' : 'w-full'} bg-white flex flex-col overflow-hidden`}> 
          ...
          <div className="flex-1 overflow-y-auto bg-gray-100" ref={previewContentRef} style={{ position: 'relative', zIndex: 0 }}>
...
const LivePaginatedPreview = React.memo(function LivePaginatedPreview({
  ...
  useEffect(() => {
    ...
    container.addEventListener('beforeinput', preventTyping);

    return () => {
      container.removeEventListener('beforeinput', preventTyping);
    };
  }, []);
