      ...
      {sectionVisibility.internships && (data.internships?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['internships'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
          onMouseEnter={() => handleMouseEnter('internships')}
          onMouseLeave={() => handleMouseLeave('internships')}
        > 
          <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-300 pb-1 mb-3">
            Internships
          </h2>
              ...
              <div key={index} className="resume-section"> 
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    >
                      {internship.designation || "Intern Position"}
                    </h3>
                    <p 
      ...
      {sectionVisibility.academicProjects && (data.academic_projects?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['academicProjects'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
          onMouseEnter={() => handleMouseEnter('academicProjects')}
          onMouseLeave={() => handleMouseLeave('academicProjects')}
        > 
          <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-300 pb-1 mb-3">
            Academic Projects
          </h2>
      ...
      {sectionVisibility.pors && (data.positions_of_responsibility?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['pors'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
          onMouseEnter={() => handleMouseEnter('pors')}
          onMouseLeave={() => handleMouseLeave('pors')}
        > 
          <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-300 pb-1 mb-3">
            Positions of Responsibility
          </h2>
              ...
              <div key={index} className="resume-section"> 
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    {por.location && (
                      <p className="text-sm text-gray-500">{por.location}</p>
                    )}
                  </div>
                  <span className="text-sm text-gray-500">
                    {por.duration}
      ...
      {sectionVisibility.achievements && (data.achievements?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['achievements'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
          onMouseEnter={() => handleMouseEnter('achievements')}
          onMouseLeave={() => handleMouseLeave('achievements')}
        > 
          <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-300 pb-1 mb-3">
            Achievements
          </h2>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    {achievement.awarding_body && (
                      <p className="text-gray-600 text-sm">{achievement.awarding_body}</p>
                    )}
      ...
      {sectionVisibility.certifications && (data.certifications?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['certifications'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
              ...
              <div key={index} className="resume-section"> 
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    >
                      {cert.certification || "Certification Name"}
                    </h3>
      ...
      {sectionVisibility.extraCurricular && (data.extra_curriculars?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['extraCurricular'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
          onMouseEnter={() => handleMouseEnter('extraCurricular')}
          onMouseLeave={() => handleMouseLeave('extraCurricular')}
        > 
          <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-300 pb-1 mb-3">
            Extra Curricular Activities
          </h2>
              ...
              <div key={index} className="resume-section"> 
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    {activity.position && (
                      <p className="text-gray-600">{activity.position}</p>
                    )}
      ...
      {sectionVisibility.languages && (data.languages?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['languages'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
      ...
      {sectionVisibility.interests && (data.interests?.length ?? 0) > 0 && (
        <div 
          ...
          style={{
            cursor: 'pointer',
            transition: 'background-color 0.2s ease-in-out',
            backgroundColor: hoverStates['interests'] ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
            padding: '8px',
            borderRadius: '4px'
          }}
          onMouseEnter={() => handleMouseEnter('interests')}
          onMouseLeave={() => handleMouseLeave('interests')}
        > 
          <h2 className="text-lg font-semibold text-gray-900 border-b border-gray-300 pb-1 mb-3">
            Interests
          </h2>
  ...
  if (isLoading) {
    return (
      <div className="expandable-outer-live">
        <div className="expandable-a4-live">
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <LoadingSpinner size="lg" className="mx-auto mb-4" />
