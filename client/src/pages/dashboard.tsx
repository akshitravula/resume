...
export default function Dashboard() {
  ...
  console.log("Fetched resumes:", user);
  ...
  const createResumeMutation = useMutation({
    mutationFn: async (templateId: number) => {
      ...
      requestData.append("template", "xyz"); // Placeholder, adjust as needed
      requestData.append("industry", `${user?.industries}` || "NONE"); // Placeholder, adjust as needed
      ...
      <div className="p-6 space-y-8 relative z-0">
        ...
        <div className="space-y-6">
          ...
          {inProgressResumes.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {displayedInProgressResumes.map((resume,index) => {
